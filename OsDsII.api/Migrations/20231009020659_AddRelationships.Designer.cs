...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20231009020659_AddRelationships")]
            ...
            modelBuilder.Entity("OsDsII.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OpeningDate")
                        ...
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 8, 23, 6, 59, 467, DateTimeKind.Unspecified).AddTicks(6231), new TimeSpan(0, -3, 0, 0, 0)))
